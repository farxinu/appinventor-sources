package edu.mit.appinventor.cognitiveservices;
...
/**
 */
@DesignerComponent(version = YaVersion.SENTIMENT_COMPONENT_VERSION,
...
public class Sentiment extends AndroidNonvisibleComponent implements Component {

  private static final String LOG_TAG = "SentimentAnalysis";
  ...
  private String urlString = "https://eastus2.api.cognitive.microsoft.com/text/analytics/v2.0/sentiment";
  private YailList requestHeaders = new YailList();
  private String subscriptionKey = "c94d991e479143b9b71d686516308b7d";
  private String inputString = "";

  /**
   * Creates a new SentimentAnalysis component.
   *
   * @param container the Form that this component is contained in.
   */
  public Sentiment(ComponentContainer container) {
   ...
   *
   */
  @SimpleFunction(description = "Makes a request to Cognitive Services")
